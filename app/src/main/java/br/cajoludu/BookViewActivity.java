        ...
        previewBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(previewLink.isEmpty()){
                    ...
                    Toast.makeText(BookViewActivity.this, "No preview Link present", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        buyBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (buyLink.isEmpty()) {
                    ...
                    Toast.makeText(BookViewActivity.this, "No buy page present for this book", Toast.LENGTH_SHORT).show();
                    return;
                }
